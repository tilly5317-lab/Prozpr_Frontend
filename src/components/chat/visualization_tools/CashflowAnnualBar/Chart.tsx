    ...
    <div className="my-3 rounded-xl border border-border bg-card p-3">
      <div className="flex items-center justify-between mb-2">
        ...
        <button
          ...
          className="inline-flex h-7 items-center gap-1.5 rounded-md border border-border bg-background px-2.5 text-[11px] font-medium text-foreground shadow-sm hover:bg-muted/60 transition-colors"
        >
