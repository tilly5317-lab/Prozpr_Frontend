...
/** Keep charts responsive for very long NAV series. */
  ...
  return (
    <div className="mobile-container flex min-h-screen flex-col bg-background">
      ...
      <main className="flex-1 space-y-3 px-[14px] pb-28 pt-4">
        ...
        {!loading && data && (
          <>
            {/* NAV chart — first; data from mf_nav_history */}
            ...
            {/* Returns from mf_nav_history (server-calculated) */}
            <Card className="overflow-hidden border-border/60 shadow-sm">
              ...
              <CardContent className="p-4">
                {!data.position ? (
                  <p className="text-[13px] text-muted-foreground">
                    No position found for this scheme in your portfolio yet. Import a CAS statement or sync holdings.
                  </p>
                ) : (
              ...
              <CardContent className="p-0">
                {data.transactions.length === 0 ? (
                  <p className="p-4 text-[13px] text-muted-foreground">
                    No transactions recorded for this scheme yet.
                  </p>
                ) : (
            ...
            <p className="pb-2 text-center text-[10px] text-muted-foreground">
              NAV chart and trailing returns use <span className="font-mono">mf_nav_history</span>. Holdings and
              transactions reflect CAS ingest and normalisation.
            </p>
          </>
        )}
      </main>
